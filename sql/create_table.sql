...
(
    ...
    `category_level` tinyint(4)  NOT NULL DEFAULT '0' COMMENT '分类级别',
...
(
    ...
    `product_cover_image_url` varchar(200)        NOT NULL DEFAULT '' COMMENT '商品主图',
    ...
    `product_status`          tinyint(4)          NOT NULL DEFAULT '0' COMMENT '商品上架状态 1-下架 0-上架',
    `is_deleted`              tinyint(4)          NOT NULL DEFAULT '0' COMMENT '删除标识字段(0-未删除 1-已删除)',
...
(
    `bag_item_id`    bigint(20) NOT NULL AUTO_INCREMENT COMMENT '购物项目id',
    `product_id`     bigint(20) NOT NULL DEFAULT '0' COMMENT '关联商品id',
    `product_amount` int(11)    NOT NULL DEFAULT '1' COMMENT '数量',
